...
class FlaxBaichuanM1ForCausalLM(metaclass=DummyObject):
    _backends = ["flax"]
...
class FlaxBaichuanM1Model(metaclass=DummyObject):
    _backends = ["flax"]
...
class FlaxBaichuanM1PreTrainedModel(metaclass=DummyObject):
    _backends = ["flax"]
